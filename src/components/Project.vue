            ...
            <div class="border-t border-gray-200">
              <dl>
                ...
                <div
                  ...
                  "
                >
                  <dt class="text-sm font-medium text-gray-500">Time spend</dt>
                  <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    0:30
                  </dd>
                </div>
                ...
                >
                  ...
                  <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    <ul>
                      ...
                      <li>Make gut repo</li>
                      <li>Order Pizza</li>
                      <li>Implement tailwind components</li>
                      <li>Implement Login / Signup</li>
                    </ul>
                  </dd>
                </div>
                <div
...
export default {
  name: "Project",
  props: ["description", "title", "created"],
};
</script>
